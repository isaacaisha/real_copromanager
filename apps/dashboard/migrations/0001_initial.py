    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proprietaire', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='dashboard.coproprietaire')),
                ('immeuble', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.immeuble')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(max_length=255)),
                ('email', models.EmailField(max_length=254)),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='super_syndic_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Syndic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('syndic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.syndic')),
            ],
        ),
        migrations.CreateModel(
            name='License',
            fields=[
                ...
                ('license_base', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='licenses', to='dashboard.licensebase')),
                ('super_syndic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='super_syndic_licenses', to='dashboard.supersyndic')),
                ('syndic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='syndic_licenses', to='dashboard.syndic')),
            ],
        ),
        migrations.AddField(
            model_name='immeuble',
            name='syndic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.syndic'),
        ),
        migrations.AddField(
