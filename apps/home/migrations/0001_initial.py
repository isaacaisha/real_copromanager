    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_base', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='licenses', to='home.licensebase')),
                ('supersyndic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='supersyndic_licenses', to='home.supersyndic')),
                ('syndic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='syndic_licenses', to='home.syndic')),
            ],
        ),
        migrations.AddField(
            model_name='immeuble',
